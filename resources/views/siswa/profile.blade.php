    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/siswa/addnilai/{{ $siswa->id }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group {{ $errors->has('nilai') ? ' has->error ' : '' }}">
                        ...
                        <input type="text" class="form-control" id="nilai" name="nilai" placeholder="Input nilai" value="{{ old('nilai') }}">
